...
class BackgroundResultMoreDetailsScreen extends StatelessWidget {
  ...
  const BackgroundResultMoreDetailsScreen({super.key, required this.person});
        ...
        child: Column(
          ...
          children: [
            ...
            _buildInfoBox([
              ...
              // _buildInfoRow("AGE", person.age.toString()),
              _buildInfoRow("IS DECEASED", person.isDead ? "YES" : "NO"),
            ]),
