...
To access certain features of the Services, you must create an account (“Account”) by providing accurate details, including your [name, relationship status, email address, username, city and state, birth date, and a photo]. You must be at least 18 years old to register. We may reject any registration information at our discretion. You agree to: (i) choose a unique, non-offensive username and email not used by others; (ii) avoid impersonating anyone or infringing others’ rights; (iii) provide truthful, current information; (iv) safeguard your Account credentials; (v) notify us promptly at [support@vetteddatingadvice.com] of any unauthorized access; and (vi) refrain from transferring or selling your Account. You are responsible for all activities under your Account, and we may suspend or terminate it if you violate this Agreement or applicable laws.
...
Cancellation takes effect at the end of the current Subscription Period. To delete your Account, email [support@vetteddatingadvice.com] with your account identifier.
...
E-mail address: [support@vetteddatingadvice.com]
...
We will use our best efforts to resolve any potential disputes through informal, good faith negotiations. If a potential dispute arises, you must contact us by sending an email to [support@vetteddatingadvice.com] so that we can attempt to resolve it without resorting to formal dispute resolution. If we aren't able to reach an informal resolution within sixty (60) days of your email receipt, then you and we both agree to resolve the potential dispute according to the process set forth below.
...
Accessibility – Our Site and Services are designed with accessibility features to help ensure they are accessible to everyone. If you have a disability or need assistance accessing any portion of our website, please contact us at [support@vetteddatingadvice.com].
...
Contact Us – If you have questions or concerns regarding this Agreement, or if you have a complaint, please contact us [support@vetteddatingadvice.com].
