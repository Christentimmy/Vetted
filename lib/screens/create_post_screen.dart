...
import 'woman_post_screen.dart';
import 'poll_post_screen.dart';
...
class _CreatePostScreenState extends State<CreatePostScreen> {
            ...
            children: [
              ...
              GestureDetector(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (_) => const WomanPostScreen()),
                  );
                },
              ...
              GestureDetector(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (_) => const PollPostScreen()),
                  );
                },
                child: _buildPostOption("assets/images/icons/poll.png", "Poll"),
              ),
  ...
  Widget _buildPostOption(String imagePath, String label) {
    return Row(
      children: [
